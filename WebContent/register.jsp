...
<!-- Author: Catherine Yeager, Anne Whitman -->
...
<body>
	<div class="trans">
		...
		<form method="post" action="registerMe.jsp">
			<%
			    try {
							if (request.getParameter("error").equals("nopass")) {
								...
								out.println(
										"<p style='color: red'><b>Username, Account Number, or SSN taken. Please enter new one.</b></p>");
							}
						} catch (Exception e) {
			...
			<div>
				<label>First Name:</label> <input id="field" type="text"
					name='first_name' required />
			</div>

			<div>
				<label>Last Name:</label> <input id="field" type="text"
					name='last_name' required />
			</div>


			<div>
				<label>Username:</label> <input id="field" type="text"
					name='username' required />
			</div>

			<div>
				<label>Password:</label> <input id="field" type="password"
					name="password" required>
			</div>

			<div>
				<label> Re-Type Password:</label> <input id="field" type="password"
			...
			<div>
				<label>Street Address:</label><input id="field" type="text"
			...
			<div>
				<label>State:(two capital letters)</label><input id="field"
					type="text" pattern='[A-Z]{2}' name='state' required />
			</div>
			<div>
				<label>Zipcode: (5 digits)</label><input id="field" type="text"
					pattern='\d{5}' name='zipcode' required />
			</div>
			...
			<div>
				<label>Phone: (10 digits, numbers only)</label><input id="field"
					type="tel" pattern='\d{10}' name='phone' required />
			</div>
